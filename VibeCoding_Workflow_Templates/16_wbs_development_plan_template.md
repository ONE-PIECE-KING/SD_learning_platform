...
## 🔄 3天整合週期 (Integration Sprint)

> **適用於 4-6 人協作團隊**，採用 Contract-First + Module Ownership 模式
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  Day 1 (契約日)           Day 2 (開發日)         Day 3 (整合日)  │
│  ┌──────────────┐        ┌──────────────┐      ┌──────────────┐│
│  │ 09:00 Sync   │        │              │      │ 平行開發     ││
│  │ 10:00 契約   │   →    │ 平行開發     │  →   │ 14:00 PR     ││
│  │ 14:00 Review │        │ (各自模組)   │      │ 15:00 Merge  ││
│  │ 16:00 簽核   │        │              │      │ 17:00 測試   ││
│  └──────────────┘        └──────────────┘      └──────────────┘│
│                                                                 │
│  產出:                    產出:                  產出:           │
│  • 契約文件              • Feature branches    • develop 更新   │
│  • 任務分配              • 本地測試通過        • 整合測試通過   │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
| 週期 | Day 1 契約定義 | Day 2-3 開發任務 | Day 3 整合目標 |
|------|---------------|------------------|---------------|
| Sprint 1 | 定義基礎架構契約 | 3.1.x 基礎架構建置 | 基礎架構可用 |
| Sprint 2 | 定義核心模組契約 | 3.2.x 核心模組開發 | 核心功能完成 |
| Sprint 3 | 定義 API 契約 | 3.3.x + 4.x 前後端開發 | 前後端整合 |
| Sprint 4 | 測試計畫確認 | 5.x 測試執行 | 品質驗證完成 |
...
1. contracts/*           (契約層)     ← 最先
2. backend/core          (基礎層)
3. backend/services      (服務層)
4. backend/api           (API層)
5. frontend/core         (前端基礎)
6. frontend/components   (元件層)
7. frontend/features/*   (功能層)     ← 最後
```
...
| **技術負責人 (TL)** | [姓名] | 技術決策、架構設計、代碼審查、契約核准 |
| **產品經理 (PO)** | [姓名] | 需求定義、使用者故事、驗收標準 |
| **架構師 (ARCH)** | [姓名/角色] | 系統架構、技術選型、設計決策 |
| **質量控制 (QA)** | [姓名/系統] | 測試策略、品質保證、合規檢查 |

### 👤 模組所有權分配 (Module Ownership)

> **協作模式**: Contract-First + Module Ownership | **整合週期**: 3 天

| 模組 | Owner | Backup | 契約檔案 | 依賴模組 |
|------|-------|--------|----------|----------|
| `backend/core` | [Backend Lead] | [TL] | `contracts/core_contract.py` | - |
| `backend/api` | [Backend Lead] | [Backend Dev] | `contracts/api.yaml` | core |
| `backend/auth` | [Backend Dev A] | [Backend Lead] | `contracts/auth_contract.py` | core |
| `frontend/core` | [Frontend Lead] | [TL] | `contracts/core.contract.ts` | - |
| `frontend/components` | [Frontend Lead] | [Frontend Dev] | `contracts/components.contract.ts` | core |
| `frontend/features/A` | [Frontend Dev A] | [Frontend Lead] | `contracts/featureA.contract.ts` | components, api |
| `frontend/features/B` | [Frontend Dev B] | [Frontend Lead] | `contracts/featureB.contract.ts` | components, api |
...
> **協作說明**: 此階段由 Backend Lead 主導，完成後提供契約給其他模組依賴

| 任務編號 | 任務名稱 | Owner | Backup | 工時(h) | 狀態 | 完成日期 | 依賴契約 | 產出契約 | 可並行 |
|---------|---------|-------|--------|---------|------|----------|----------|----------|--------|
| 3.1.1 | 專案結構初始化 | [Backend Lead] | [TL] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | - | ❌ |
| 3.1.2 | 框架設置與配置 | [Backend Lead] | [TL] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | - | ❌ |
| 3.1.3 | 資料庫連接實作 | [Backend Dev A] | [Backend Lead] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | `db_contract.py` | ✅ |
| 3.1.4 | 資料模型定義 | [Backend Dev A] | [Backend Lead] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | `models_contract.py` | ✅ |
| 3.1.5 | 基礎 API 端點實作 | [Backend Lead] | [Backend Dev] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | `models_contract.py` | `api.yaml` | ❌ |
| 3.1.6 | 中間件設置 | [Backend Dev B] | [Backend Lead] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | - | ✅ |
| 3.1.7 | 配置管理系統 | [Backend Dev B] | [Backend Lead] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | `config_contract.py` | ✅ |
| 3.1.8 | 開發環境配置 | [Backend Lead] | [TL] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | - | - | ✅ |
| 3.1.9 | API 文檔生成 | [Backend Lead] | [Backend Dev] | [X] | [✅/🔄/⬜] | [YYYY-MM-DD] | `api.yaml` | - | ❌ |

**欄位說明**:
- **Owner**: 主要負責人，有權直接修改
- **Backup**: 備援人員，Owner 不在時可代理
- **依賴契約**: 此任務需要先完成的契約
- **產出契約**: 此任務完成後產出的契約，供其他模組依賴
- **可並行**: ✅ 表示可與其他任務同時進行
