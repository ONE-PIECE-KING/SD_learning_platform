...
Revision ID: a72f4d3cba46
Revises: 
Create Date: 2025-12-29 22:18:17.270315
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('DRAFT', 'PENDING_REVIEW', 'PUBLISHED', 'REJECTED', name='coursestatus'), nullable=False),
    sa.Column('category', sa.Enum('SOFTWARE_DEV', 'DATA_SCIENCE', 'OTHER', name='coursecategory'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('enrollment_id', 'video_id', name='uq_progress_enrollment_video')
    )
